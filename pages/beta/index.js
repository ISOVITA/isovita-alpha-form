        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-10 mb-16">
            <div className="rounded-3xl overflow-hidden aspect-[4/3]">
              <img src="/isovita_fruit_pouches.jpg" alt="ISOVITA Fruit Line" className="w-full h-full object-cover" />
            </div>
            <div className="rounded-3xl overflow-hidden aspect-[4/3]">
              <img src="/isovita_savoury_pouches.jpeg" alt="ISOVITA Savoury Line" className="w-full h-full object-cover" />
            </div>
          </div>
